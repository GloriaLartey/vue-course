...
provide('studentName2', 'Gloria')
provide('studentAge2', 22)
provide('studentLocation2', ['Earth', 'IDK'])

//provide Array
provide('friends', ['Alex', 'Jordan', 'Ria', 'John'])
...
provide('moreGames', [
  {
    ...
    genre: 'Sci-Fi',
    platform: 'PC',
    realeaseDate: '2023-05-20'
  },
  {
    title: 'Fantasy Quest',
    genre: 'Fantasy',
    platform: 'PlayStation',
    realeaseDate: '2023-07-10'
  },
  {
    title: 'Inception',
